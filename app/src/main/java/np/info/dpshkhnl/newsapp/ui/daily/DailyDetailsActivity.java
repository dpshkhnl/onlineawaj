...
import np.info.dpshkhnl.newsapp.database.table.DailyTable;
import np.info.dpshkhnl.newsapp.model.daily.DailyDetailsBean;
import np.info.dpshkhnl.newsapp.model.daily.StoryBean;
import np.info.dpshkhnl.newsapp.support.CONSTANT;
import np.info.dpshkhnl.newsapp.support.DisplayUtil;
...
import np.info.dpshkhnl.newsapp.ui.support.BaseDetailsActivity;
