...
package np.info.dpshkhnl.newsapp.database;
...
import np.info.dpshkhnl.newsapp.database.table.ReadingTable;
import np.info.dpshkhnl.newsapp.database.table.ScienceTable;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    private  static final String DB_NAME= "onlineaawaz";
