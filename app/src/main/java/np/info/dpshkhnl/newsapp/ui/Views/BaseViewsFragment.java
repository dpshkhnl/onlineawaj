package np.info.dpshkhnl.newsapp.ui.Views;
...
import np.info.dpshkhnl.newsapp.api.ViewsApi;
...
public class BaseViewsFragment extends AbsTopNavigationFragment {
  private PagerAdapter pagerAdapter;
  private String [] name ;
  private String [] url ;
  @Override
  protected PagerAdapter initPagerAdapter() {
    name = ViewsApi.getNewsTitle();
    url = ViewsApi.getNewsUrl();
