...
package np.info.dpshkhnl.newsapp.support.adapter;
...
import np.info.dpshkhnl.newsapp.api.DailyApi;
import np.info.dpshkhnl.newsapp.database.cache.ICache;
import np.info.dpshkhnl.newsapp.model.daily.StoryBean;
import np.info.dpshkhnl.newsapp.support.HttpUtil;
import np.info.dpshkhnl.newsapp.support.Settings;
import np.info.dpshkhnl.newsapp.ui.daily.DailyDetailsActivity;

import np.info.dpshkhnl.newsapp.support.adapter.DailyAdapter.ViewHolder;
